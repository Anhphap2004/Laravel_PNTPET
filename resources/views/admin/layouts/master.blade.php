            ...
            <div class="iq-sidebar-logo d-flex justify-content-between">
               <a href="index.html" class="header-logo">
                  ...
                  <div class="logo-title">
                     <span class="text-danger text-uppercase">Anhh<span class="text-primary ml-1">Phapp</span></span>
                  </div>
               </a>
               ...
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     <li class="active active-menu">
                      <a href="index.html"><i class="las la-house-damage"></i>Trang Chủ</a>
                  ...
                  <div class="iq-card bg-primary rounded">
                     <div class="iq-card-body">
                        <div class="sidebarbottom-content">
                           ...
                           <h5 class="mb-3 text-white">Anhh Phapp</h5>
                           <p class="mb-0 text-light">Hãy Thích Mèo và Động Vật.</p>
                           <button type="submit" class="btn btn-white w-100  mt-4 text-primary viwe-more">Xem Thêm</button>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="navbar-breadcrumb">
                     <h4 class="mb-0 text-dark">Trang Chủ</h4>
                     <p class="mb-0"><span class="text-danger">Hi các em,</span> Trang web a chế ra có đẹp hong</p>
                  </div>
                        ...
                        <li class="nav-item nav-icon">
                           <div class="iq-search-bar">
                              <form action="#" class="searchbox">
                                 <input type="text" class="text search-input" placeholder="Nhập tìm kiếm...">
...
<img src="{{ asset('admin/images/Username/' . Auth::user()->profile_image) }}"
     class="img-fluid rounded-circle"
     alt="Admin Avatar"
     onerror="this.onerror=null;this.src='{{ asset('admin/images/user/default.png') }}';">
    ...
    Hello, {{ Auth::user()->username ?? 'Admin' }}
                                    ...
                                    <span class="text-white font-size-12">Chưa ngiu</span>
                                 </div>
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-lg-6 text-right">
                  Được Tạo Năm 2025 <a href="#">Anhh Phapp</a> All Rights Reserved.
               </div>
            </div>
         </div>
      </footer>
      ...
      <div class="iq-colorbox color-fix">
         ...
         <div id="right-sidebar-scrollbar" class="iq-colorbox-inner">
            <div class="clearfix color-picker">
               <h3 class="iq-font-black">Anhh Phapp Awesome Color</h3>
