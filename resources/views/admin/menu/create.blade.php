...
<div class="content-wrapper">
    <div class="page-intro">
        <h4>Thêm Menu Mới</h4>
        <p>Tạo menu mới với thông tin chi tiết và cài đặt hiển thị.</p>
    </div>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.menu.store') }}" method="POST">
            @csrf
            <input type="hidden" name="menu_id" value="1"> {{-- hoặc value dynamic --}}
            ...
            <div class="form-group">
                ...
                <input type="text" name="icon_class" class="form-input">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="order_index" class="form-input" value="0">
            </div>
